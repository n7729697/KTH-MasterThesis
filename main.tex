...
\centering
    ...
    inline]{5}{36}
        ...
        \ganttgroup[progress=100]{Model Development}{10}{14} \\
        \ganttbar[inline = false, progress=100]{Feature extraction}{10}{11} \\
        \ganttbar[inline = false, progress=100]{Collect data}{11}{13} \\
        \ganttbar[inline = false, progress=100]{Train surrogate model}{13}{14} \\
        
        
        \ganttgroup[progress=30]{Algorithm Development}{14}{19} \\
        \ganttbar[inline = false, progress=90]{Implement model}{14}{15} \\
        \ganttbar[inline = false, progress=50]{Design MBRL algorithm}{15}{17} \\
        \ganttbar[inline = false, progress=30]{Simulate algorithm}{17}{19} \\
        ...
        \ganttgroup[progress=20, group progress label anchor=south]{Report Writing}{10}{35} \\
        \ganttbar[inline = false, progress=30]{Writing thesis draft}{10}{26} \\
