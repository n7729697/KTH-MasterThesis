...
\begin{table}[hp]
    ...
    \begin{tabular}{|cp{5cm}p{5cm}|}
        ...
        \multicolumn{1}{|p{3.875cm}}{\begin{tabular}[l]{@{}c@{}}\includegraphics[width=0.5\linewidth]{setup/img/kth\_logo.eps}\\ \tiny\bfseries KTH Industrial Engineering \vspace*{-0.3cm}\\ \tiny\bfseries and Management\end{tabular}} &
          \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}\textbf{Master of Science Thesis TRITA-ITM-EX 2023:XXX}\\ \\ \\ \textbf{Optimal Gait Control of Soft Quadruped Robot} \\ \textbf{by Model-based Reinforcement Learning}\vspace{2em}\end{tabular}} \\
        \multicolumn{1}{|c}{} &
